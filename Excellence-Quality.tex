...
This project will deploy approaches of {statistics} and {machine learning} to security games  played repeatedly between a defender and attackers. Repeated security games allow for collection of data, which can in turn be used to estimate the game and influence future behaviour. %Another possibility is in fact that the defender can in turn test the game and collect (in the most efficient and less costly manner) more information about the game. 
